define(["require", "exports", '../util/stream', '../util/struct', '../util/math'], function(require, exports, stream, struct, math_utils) {
    ...
    var DirectoryRecordDate = (function () {
        ...
        DirectoryRecordDate.struct = struct.StructClass.create(DirectoryRecordDate, [
    ...
    var IsoStringDate = (function () {
        ...
        IsoStringDate.struct = struct.StructClass.create(IsoStringDate, [
    ...
    var VolumeDescriptorHeader = (function () {
        ...
        VolumeDescriptorHeader.struct = struct.StructClass.create(VolumeDescriptorHeader, [
    ...
    var DirectoryRecord = (function () {
        ...
        DirectoryRecord.struct = struct.StructClass.create(DirectoryRecord, [
    ...
    var PrimaryVolumeDescriptor = (function () {
        ...
        PrimaryVolumeDescriptor.struct = struct.StructClass.create(PrimaryVolumeDescriptor, [
            ...
            { type: struct.StructArray.create(struct.UInt8, 0x200), name: 'pad5' },
            { type: struct.StructArray.create(struct.UInt8, 653), name: 'pad6' }
        ]);
