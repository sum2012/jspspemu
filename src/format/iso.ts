...
class DirectoryRecordDate {
    ...
    static struct = struct.StructClass.create<DirectoryRecordDate>(DirectoryRecordDate, [
		{ type: struct.UInt8, name: 'year' },
		{ type: struct.UInt8, name: 'month' },
		{ type: struct.UInt8, name: 'day' },
		{ type: struct.UInt8, name: 'hour' },
		{ type: struct.UInt8, name: 'minute' },
		{ type: struct.UInt8, name: 'second' },
		{ type: struct.UInt8, name: 'offset' },
	]);
}
...
class IsoStringDate {
	...
	static struct = struct.StructClass.create<IsoStringDate>(IsoStringDate, [
		{ type: struct.Stringz(17), name: 'data' },
    ]);
}
...
class VolumeDescriptorHeader
{
	...
	static struct = struct.StructClass.create<VolumeDescriptorHeader>(VolumeDescriptorHeader, [
		{ type: struct.UInt8, name: 'type' },
		{ type: struct.Stringz(5), name: 'id' },
...
class DirectoryRecord {
	...
	static struct = struct.StructClass.create<DirectoryRecord>(DirectoryRecord, <struct.StructEntry[]>[
		{ type: struct.UInt8, name: 'length' },
		{ type: struct.UInt8, name: 'extendedAttributeLength' },
		{ type: struct.UInt32_2lb, name: 'extent' },
		{ type: struct.UInt32_2lb, name: 'size' },
        { type: DirectoryRecordDate.struct, name: 'date' },
		{ type: struct.UInt8, name: 'flags' },
		{ type: struct.UInt8, name: 'fileUnitSize' },
		{ type: struct.UInt8, name: 'interleave' },
		{ type: struct.UInt16_2lb, name: 'volumeSequenceNumber' },
		{ type: struct.UInt8, name: 'nameLength' },
    ]);
}
...
class PrimaryVolumeDescriptor
{
	...
	static struct = struct.StructClass.create<PrimaryVolumeDescriptor>(PrimaryVolumeDescriptor, <struct.StructEntry[]>[
		{ type: VolumeDescriptorHeader.struct, name: 'header' },
		{ type: struct.UInt8, name: '_pad1' },
		{ type: struct.Stringz(0x20), name: 'systemId' },
		{ type: struct.Stringz(0x20), name: 'volumeId' },
		{ type: struct.Int64, name: '_pad2' },

		{ type: struct.UInt32_2lb, name: 'volumeSpaceSize' },
		{ type: struct.StructArray.create(struct.Int64, 4), name: '_pad3' },
		{ type: struct.UInt32, name: 'volumeSetSize' },
		{ type: struct.UInt32, name: 'volumeSequenceNumber' },
		{ type: struct.UInt16_2lb, name: 'logicalBlockSize' },
		{ type: struct.UInt32_2lb, name: 'pathTableSize' },

		{ type: struct.UInt32, name: 'typeLPathTable' },
		{ type: struct.UInt32, name: 'optType1PathTable' },
		{ type: struct.UInt32, name: 'typeMPathTable' },
		{ type: struct.UInt32, name: 'optTypeMPathTable' },

        { type: DirectoryRecord.struct, name: 'directoryRecord' },
		{ type: struct.UInt8, name: '_pad4' },

		{ type: struct.Stringz(0x80), name: 'volumeSetId' },
		{ type: struct.Stringz(0x80), name: 'publisherId' },
		{ type: struct.Stringz(0x80), name: 'preparerId' },
		{ type: struct.Stringz(0x80), name: 'applicationId' },
		{ type: struct.Stringz(37), name: 'copyrightFileId' },
		{ type: struct.Stringz(37), name: 'abstractFileId' },
		{ type: struct.Stringz(37), name: 'bibliographicFileId' },
		...
		{ type: struct.UInt8, name: 'fileStructureVersion' },
		{ type: struct.UInt8, name: 'pad5' },
		{ type: struct.StructArray.create<number>(struct.UInt8, 0x200), name: 'pad5' },
		{ type: struct.StructArray.create<number>(struct.UInt8, 653), name: 'pad6' },
	]);
}
