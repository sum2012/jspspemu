define(["require", "exports", '../display', './state'], function(require, exports, display, state) {
    var PixelConverter = display.PixelConverter;
    var PixelFormat = display.PixelFormat;

    var PrimitiveType = state.PrimitiveType;
    var CullingDirection = state.CullingDirection;
